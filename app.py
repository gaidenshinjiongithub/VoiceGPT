...
while True: 
    ...
    if fuzz.token_set_ratio(user_input.lower(), "what is your return policy") >= 60:
    ...
    elif fuzz.token_set_ratio(user_input.lower(), "where is my order") >= 60:
    ...
    elif fuzz.token_set_ratio(user_input.lower(), "how do I contact support") >= 60:
    ...
    elif fuzz.token_set_ratio(user_input.lower(), "I want to cancel my order") >= 60:
